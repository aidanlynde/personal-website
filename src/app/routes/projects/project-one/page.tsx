// src/app/routes/projects/project-one/page.tsx
"use client";
...
export default function ProjectOnePage() {
  ...
  const MemoizedImageComponent = ({ src, alt }: MemoizedImageProps) => (
    <Image src={src} alt={alt} width={400} height={300} priority />
  );

  MemoizedImageComponent.displayName = 'MemoizedImageComponent';

  const MemoizedImage = memo(MemoizedImageComponent);
